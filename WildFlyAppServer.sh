...
#git clone https://github.com/YegorMaksymchuk/WildFly-Servlet-Example.git
cd WildFly-Servlet-Example/
...
cd WildFly-Servlet-Example/
git add -A
git commit -m 'My First WildFly Application'
git remote add WildFly https://github.com/Diliri/WildFly.git
git push -u -f WildFly main
#ls
# git push
